...
;; Police :
;; on la définit dans .Xdefaults,
;; ainsi X et console ont deux polices différentes

;; Theme :
;; Le premier est pour X et le second pour la console
(setq color-theme-choices 
      '(color-theme-charcoal-black color-theme-standard))
...
;; test pour cadre ou console supplémentaire
(require 'cl)
(fset 'test-win-sys 
      (funcall (lambda (cols)
...
(custom-set-faces
 ...
 '(font-latex-bold-face ((((class color) (background dark)) (:inherit bold :foreground "OliveDrab" :weight bold))))
 '(font-latex-italic-face ((((class color) (background dark)) (:inherit italic :foreground "OliveDrab" :slant italic))))
 '(hl-line ((t (:stipple nil :underline "red")))))

(setq-default TeX-master nil) ;; euh..?
...
(custom-set-variables
 ...
 '(font-latex-match-function-keywords (quote (("textgreek" "") ("tg" "") ("tde" ""))))
 '(font-latex-match-italic-command-keywords nil)
 '(font-latex-user-keyword-classes (quote (("texte-allemand" (("tde")) (:inherit italic :slant italic :foreground "yellow") command))))
...
;;(add-hook 'text-mode-hook 'turn-on-setnu-mode) ; c'est pas cool en text-mode, par contre faudrait le faire sur les fichiers de confs
